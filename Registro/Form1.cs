...
namespace Registro
{
    public partial class Form1 : Form
    {
        ...
        Pessoas pessoasAux = new Pessoas();
        Pessoa pessoa;
        ...
        private void Cadastrar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Pessoa p = new Pessoa(Nome.Text, Telefone.Text, CPF.Text, Email.Text, Nascimento.Value.Date);
                pessoasAux = pessoas;
                pessoasAux.AddPessoas(p);

                connection.OpenDB();                         
                connection.InsertDB(p);
                connection.CloseDB();
        ...
        private void Atualizar_Click(object sender, EventArgs e)
        {
            ...
            var pes = pessoas.GetPessoaById(Guid.Parse(p.ToString()));
            connection.updateDB(pes);
            connection.CloseDB();
